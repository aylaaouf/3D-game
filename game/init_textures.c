...
int	init_textures(t_game *game)
{
	...
	game->wall_textures[0] = load_texture(game, "textures/wall_n.xpm");
	game->wall_textures[1] = load_texture(game, "textures/wall_s.xpm");
	game->wall_textures[2] = load_texture(game, "textures/wall_e.xpm");
	game->wall_textures[3] = load_texture(game, "textures/wall_w.xpm");
